...
| Název | Kategorie | Funkce | Vstup | Výstup | Typ |
|------|----------|--------|------|--------|-----|
| Magnet Axiom | Digitální forenzní analýza | Analýza zařízení a dat | Disky, cloud | Reporty | Placený |
| X-Ways Forensics | Digitální forenzní analýza | Analýza souborů | Disky | Metadata | Placený |
| Oxygen Forensic Detective | Mobilní forenzní analýza | Extrakce dat | Mobilní zařízení | SMS, chaty, multimédia | Placený |
| Cellebrite UFED | Mobilní forenzní analýza | Získání dat z mobilů | Mobilní zařízení | Kompletní data | Placený |
| MOBILedit Forensic | Mobilní forenzní analýza | Analýza mobilních dat | Mobilní zařízení | Kontakty, SMS | Placený |
| TinEye | OSINT | Reverzní vyhledávání obrázků | Obrázky | Shody | Freemium |
